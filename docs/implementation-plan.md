...
| **4.13** Workflow Studio | 业务自助编排 | **MVP ✅**（DB SSOT + `/workflows` + Chat `#` + Live 检查门）；**4.13.7** 高级图编辑 ⬜ · [workflow-studio spec](./superpowers/specs/2026-06-25-workflow-studio-design.md) · [实施计划](./superpowers/plans/2026-07-11-workflow-studio.md) |
