...
|| **4.14 Planner-Executor 重建** | 真 Planner-Executor 取代动态 Plan-Workflow | **🟡 H-0～H-6 ✅ / H-7+阶段 D ⬜**：[rebuild §7.0](./superpowers/specs/2026-08-05-planner-executor-rebuild-design.md) · routing [v6 R-0～R-3 ✅ / R-4 ⬜](./superpowers/specs/2026-07-29-unified-routing-design.md) · [unified-routing-v6-h5](./superpowers/plans/2026-08-13-unified-routing-v6-h5.md) ✅ · [H-6 frontend](./superpowers/plans/2026-08-13-planner-h6-frontend.md) ✅（TaskBoard H1 待 `tasks` SSE）· **下一波** H-7 → 阶段 D |
