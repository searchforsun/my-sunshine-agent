...
|| **4.14 Planner-Executor 重建** | 真 Planner-Executor 取代动态 Plan-Workflow | **⬜ 设计评审中（v7）+ kernel plan 待执行**：[kernel plan H-0～H-4](./superpowers/plans/2026-08-13-planner-executor-kernel.md) · [rebuild SSOT](./superpowers/specs/2026-08-05-planner-executor-rebuild-design.md) · 依赖顺序见 [specs/README](./superpowers/specs/README.md#活跃增量方案依赖与落地顺序2026-08-13) · 后续：routing/H-5～H-7 + 阶段 D |
