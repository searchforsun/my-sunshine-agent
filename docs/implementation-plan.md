...
| **4.13** Workflow Studio | 业务自助编排 | **DB 唯一 SSOT**（废弃 Nacos workflow）· Dify 式 **`/workflows`** + MySQL init 种子 **5 标杆** · **Chat `#`** · 模板 [docs/workflow/](./workflow/README.md) · [workflow-studio spec](./superpowers/specs/2026-06-25-workflow-studio-design.md) · [实施计划](./superpowers/plans/2026-07-11-workflow-studio.md) |
...
| **工作流** | **`/workflows`** | **阶段四 4.13**：Workflow Studio 可视化编辑、发布；定义 SSOT **workflow-manager DB**；种子/迁移模板 [docs/workflow/](./workflow/README.md) |
