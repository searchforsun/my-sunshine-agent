...
| **4.5** Skills 沙箱 | Coding Agent 工作区 | 独立 `sandbox-service` + 六工具 `sandbox__*`（不进 Catalog）· [详设](./superpowers/specs/2026-07-15-skills-docker-sandbox-design.md) · [计划](./superpowers/plans/2026-07-15-skills-docker-sandbox.md) |
