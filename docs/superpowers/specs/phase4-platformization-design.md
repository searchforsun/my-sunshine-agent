...
| **4.7.9** | **ReAct Request Decision**（`request_decision` 元工具，Agent 主动向用户出选择题；Chat MAIN ✅ / Planner 延后；`enabled` 默认 false） · [详设](./2026-07-28-react-request-decision-design.md) · Live `verify_decision_live.py` | ✅ Chat MAIN |
