...
**与「锁定决策」关系**：[locked-architecture-decisions.md](../superpowers/specs/archive/2026-06-19-locked-architecture-decisions.md) 约束 **D1–D11 产品/边界**；若与 ADR 冲突，以 ADR + 代码为准，并回写锁定文档 API 表。
