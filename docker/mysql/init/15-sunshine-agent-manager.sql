...
('finance-expert', '费用报销分析专家', '本人报销/费用单据与费用制度的业务分析',
...
('compliance-expert', '业务合规对照专家', '制度条款与报销/假期等业务数据的逐项合规对照',
...
('legal-expert', '合同与法务分析专家', '合同/合规类制度与业务材料的法务风险审查',
