...
def main() -> int:
    ...
    print("  LLM Gateway  :8300 | RAG :8400 | Finance :8710 | OA :8700 | HR :8720 | Tool Manager :8210 | Skill Manager :8225 | Sandbox :8226 | Workflow Manager :8230 | Expert Manager :8235")
